...
farmEachBot = 10            -- farm each bot (set 0 to infinite loop all farm)
...
worldPickaxeList = {""}                         -- multiple world pickaxe
doorPickaxe = ""                                -- Id door to enter world storage
useSafeVault = true                             -- using safe vault to take pickaxe
passSafeVault = ""                              -- password safe vault

storagePackList = {""}                     -- multiple storage
doorPack = ""                               -- Id door to enter world storage
storageSeedList = {""}                     -- multiple storage
doorSeed = ""                               -- Id door to enter world storage
xStart, xEnd = 3, 50
yStart, yEnd = 21, 0
...
-- PACK SETTINGS
packName = "world_lock"                 -- id pack
packList = {242}                        -- pack list and whitelist item to drop
packPrice = 2000                        -- pack price
buyPackCount = 5                        -- pack count u want to buy

-- WEBHOOK SETTINGS
maxBotEvents = 100                      
webhookEvents = "https://discord.com/api/webhooks/"
webhookOffline = "https://discord.com/api/webhooks/"
webhookNuked = "https://discord.com/api/webhooks/"

webhookLinkPack = "https://discord.com/api/webhooks/"
messageIdPack = ""
webhookLinkSeed = "https://discord.com/api/webhooks/"
messageIdSeed = ""

-- OPTIONAL SETTINGS
useItmWear = true               -- set true if wanna wear some items in store
itmWearID = 10158               -- itmID wear item
itmWearName = "mooncake_mag"    -- store config for items
itmWearPrice = 5000             -- price store config

dropCustomItem = true                       -- set true if wanna drop diff item from pack
...
-- MALADY SETTINGS  
autoGrumbleteeth = false         -- set true bot will spam first until get malady grumbleteeth
autoChickenfeet = false          -- set true bot will move  until get malady chicken feet
...
bot.auto_trash = true
bot:setInterval(move,moveInterval)
...
bot:setInterval(Action.collect,100)
...
function storeSeed(world)
	...
	bot:setInterval(Action.collect,10000)
    sleep(100)
